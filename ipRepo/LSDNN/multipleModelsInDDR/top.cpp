...
#pragma HLS ARRAY_PARTITION variable=l1weights cyclic factor=26 dim=2
#pragma HLS ARRAY_PARTITION variable=l2weights cyclic factor=52 dim=2
#pragma HLS ARRAY_PARTITION variable=l1bias complete dim=1
#pragma HLS ARRAY_PARTITION variable=l2bias complete dim=1
#pragma HLS array_partition variable=mean cyclic factor=13
#pragma HLS array_partition variable=stdDev cyclic factor=13
...
#pragma HLS ARRAY_PARTITION variable=Yin cyclic factor=13 dim=1
#pragma HLS ARRAY_PARTITION variable=Xin cyclic factor=13 dim=1
	COMPLEX LSOut[dim];
#pragma HLS ARRAY_PARTITION variable=LSOut cyclic factor=13 dim=1
/// Neural network variables
	dataType inVal[layer1InputSize];
#pragma HLS ARRAY_PARTITION variable=inVal cyclic factor=13 dim=1
